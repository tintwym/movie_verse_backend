...
public interface IUserMovieInteractionService {
	...
	/** Rank interacted movies locally from favorites, ratings, and watch status. */
	List<String> getRecommendedMovieIds(List<Map<String, Object>> userInteractions);
	...
	List<Integer> getWatchlistMovieIds(UUID userId);
}
